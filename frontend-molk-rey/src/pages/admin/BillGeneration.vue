  ...
  <div class="space-y-6">
    ...
    <div class="rounded-card border border-surface-border bg-surface p-4 space-y-3">
      ...
      <div v-if="strategyType === 'area_based' || strategyType === 'hybrid'">
        <label class="mb-1 block text-xs text-ink/60">مبلغ به ازای هر متر (تومان)</label>
        <input
      ...
      <div v-if="strategyType === 'hybrid'">
        <label class="mb-1 block text-xs text-ink/60">مبلغ پایه ثابت (تومان)</label>
        <input
    ...
    >
      این ساختمان هیچ واحدی ندارد؛ ابتدا از صفحه «مدیریت ساختمان و واحدها» واحد اضافه کنید.
    </p>
